...
def train_housing_prediction():
    ...
    params = {
        ...
        "Gradient Boosting": {
            ...
            "learning_rate": [0.05, 0.1], # Velocidad de aprendizaje (cuánto peso le da a cada árbol nuevo)
    ...
    df_pred = pd.DataFrame({'Precio Real (IPV)': y_test, 'Precio Predicho': y_pred_best_model})
    ...
    return global_best_model, feature_importance_df

if __name__ == "__main__":
    model, importance = train_housing_prediction()